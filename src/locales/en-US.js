export default {
  ...
  workReport: {
    navTitle: 'Work Report',
    search: {
      placeholder: 'Enter SN to search',
      button: 'Search',
    },
    tabs: {
    ...
    submit: 'Submit',
    toast: {
      snRequired: 'Please enter the SN code to search',
      loading: 'Loading…',
      planMissing: 'No related project found',
      searchFail: 'Search failed',
      noData: 'No data available to submit',
    ...
    overview: {
      ...
      table: {
        ...
        status: 'Status',
        progress: 'Progress',
        empty: 'No milestone data available',
      },
    ...
    routeCard: {
      ...
      hourStats: 'Hour summary',
      quantityStats: 'Quantity hours',
      hour: 'Hours',
      quantity: 'Quantity',
      units: {
        hour: 'hrs',
    ...
    missingMaterial: {
      navTitle: 'Missing Material Details',
      columns: {
        index: 'No.',
        code: 'Material code',
        name: 'Material name',
      ...
      empty: 'No missing material information',
      toast: {
        loadFail: 'Failed to retrieve missing material information',
        fetchFail: 'Request failed',
        missingBillNumber: 'Missing bill number information',
      },
    },
  },
};
