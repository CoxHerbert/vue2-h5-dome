  ...
  <div class="sso">
    <div class="brand-wechat">
      <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M18.4 10.2c0-3.2-3.2-5.8-7.1-5.8C7.3 4.4 4 7 4 10.2c0 1.9 1.1 3.6 2.8 4.7l-.6 2.1 2.2-1.2c.7.2 1.5.3 2.3.3 3.9 0 7.1-2.6 7.1-5.9z" fill="#09BB07"/>
...
.brand-wechat {
  ...
  padding: 8px 12px; border-radius: 12px; background: #f0fff0; color: #16a34a;
