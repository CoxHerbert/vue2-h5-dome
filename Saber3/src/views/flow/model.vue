    ...
    >
      ...
      <template #menu="scoped">
        <el-button
          ...
          @click.stop="handleUpdate(scoped.row, scoped.index)"
          >配置
        </el-button>
        <el-button
          type="primary"
          ...
          @click.stop="handleDeploy(scoped.row, scoped.index)"
          >部署
        </el-button>
        <el-button
          type="primary"
          ...
          icon="el-icon-delete"
          v-if="permission.flow_model_delete"
          @click.stop="handleSlotDelete(scoped.row, scoped.index)"
          >删除
        </el-button>
      </template>
    ...
    >
      ...
      <template #footer>
        <span class="avue-dialog__footer">
          ...
          <el-button v-if="nutflowOption.step === 1" type="primary" @click="handleStep(1)"
            >下 一 步</el-button
          >
          <el-button v-if="nutflowOption.step === 2" type="primary" @click="handleStep(-1)"
            >上 一 步</el-button
          >
