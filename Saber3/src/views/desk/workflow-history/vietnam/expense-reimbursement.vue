...
// import AddOrEdit from './page-expense-reimbursement/addOrEdit.vue';
...
const getData = async () => {
  try {
    ...
    const res = await Api.desk.expenseReimbursement.list(dataparam);
...
const doAction = async (action, scoped = {}) => {
  if (action === 'view') {
    ...
    const params = {
      processKey: 'expenseReimbursementProcess',
    };
