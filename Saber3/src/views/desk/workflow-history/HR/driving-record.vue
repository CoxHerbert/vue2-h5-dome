...
import options from './utils/page-driving-record';
// import AddOrEdit from './page-driving-record/addOrEdit.vue';
...
const getData = async () => {
  ...
  const res = await Api.desk.drivingRecord.list(dataparam);
