    ...
    <div class="body-container">
      <div class="operate-container">
        <el-button
          type="primary"
          icon="CirclePlus"
          v-permission="{ id: 'MPS_PLANSPLIT_ADD' }"
          @click="handleAdd"
          >新增</el-button
        >
          ...
          <el-table-column label="操作" align="center" fixed="right" width="180">
            <template #default="scoped">
              <el-button
                ...
                v-permission="{ id: 'MPS_PLANSPLIT_EDIT', row: scoped.row }"
              >
                编辑
              </el-button>
              <el-button
                ...
                v-permission="{ id: 'MPS_PLANSPLIT_GEN_SN', row: scoped.row }"
              ...
              <el-button
                ...
                text
                v-if="scoped.row.level === 1 && scoped.row?.isSn"
                v-permission="{ id: 'MPS_PLANSPLIT_DETAIL', row: scoped.row }"
...
import snPrintDrawer from './snPrintDrawer.vue';
