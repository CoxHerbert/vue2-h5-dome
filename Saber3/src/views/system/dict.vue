    ...
    >
      <template #menu-left>
        <el-button
          type="danger"
          icon="el-icon-delete"
          v-if="func.isOperate(permission.dict_delete)"
          plain
          @click="handleDelete"
          >删 除
        </el-button>
...
export default {
  ...
  computed: {
    ...
    permissionList() {
      return {
        addBtn: func.isOperate(this.permission.dict_add),
        delBtn: func.isOperate(this.permission.dict_delete),
        editBtn: func.isOperate(this.permission.dict_edit),
        viewBtn: false,
      };
    },
    ids() {
