  ...
  <div class="addorEdite">
    <div class="title">
      ...
      <div class="title-btns">
        ...
        >
        <el-button
          v-if="formData.flagStatusDict == 1 && title != '查看'"
          @click="submitForReview('取消审核')"
          >取消审核</el-button
        >
        <el-button
    ...
    >
      ...
      <el-row :gutter="24">
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="供应商名称:" prop="supplierName">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="供应商分类" prop="supplierClassifyDict">
            <el-select
              style="width: 100%"
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="供应商编码:" prop="supplierNotext">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="签约开始日期：" prop="startDate">
            <el-date-picker
              style="width: 100%"
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="签约结束日期：" prop="endDate">
            <el-date-picker
              style="width: 100%"
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="结算方式：" prop="paytermsDict">
            <el-select
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="组织" prop="inspectionItemName">
            <el-select
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="供应商地址:" prop="supplierAddress">
            <el-input
      ...
      <el-row :gutter="24">
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="发票抬头:" prop="invoiceTitle">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="发票税号:" prop="invoiceTaxNumber">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="发票类型:" prop="taxCategoriesDict">
            <el-select
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="增值税率:" prop="taxRate">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="开户银行:" prop="bank">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="银行账号:" prop="bankAccount">
            <el-input
        ...
        <el-col :span="8">
          <el-form-item class="form-itme-width" label="币种:" prop="currency">
            <el-select
      ...
      <el-table :data="contacts" style="width: 100%">
        ...
        <el-table-column prop="gender" label="性别" align="center" width="90">
          <template #default="scope">
            <el-select v-model="scope.row.gender" v-if="!isDisabled">
