<template>
  ...
  <el-table :data="planData" border max-height="calc(100vh - 300px)">
    <el-table-column width="40" type="">
    ...
    <el-table-column prop="handlePersonName" label="处理人" width="180" align="center">
      <template #default="scoped">
        <dc-select-user
    ...
    <el-table-column prop="businessCategoryId" label="计划类型" width="120" align="center">
      <template #default="scoped">
        <el-select
    ...
    <el-table-column prop="businessType" label="业务名称" width="160" align="center">
      <template #default="scoped">
        <el-select
    ...
    <el-table-column prop="startDate" label="开始日期" width="160" align="center">
      <template #default="scoped">
        <el-date-picker
    ...
    <el-table-column prop="endDate" label="结束日期" width="160" align="center">
      <template #default="scoped">
        <el-date-picker
    ...
    <el-table-column prop="taskDescription" label="任务说明" width="200" align="center">
      <template #default="scoped">
        <el-input
          v-if="scoped.row.isEdit"
          placeholder="请输入任务说明"
          v-model="scoped.row.taskDescription"
        />
        <span v-else>{{ scoped.row.taskDescription || '-' }}</span>
      </template>
    </el-table-column>
