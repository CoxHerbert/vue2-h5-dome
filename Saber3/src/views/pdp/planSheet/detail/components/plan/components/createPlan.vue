  ...
  >
    ...
    <div class="layout-process">
      <div class="layout-process-left">
        <div class="left-head">
          <div class="left-head_title tag-001">
            {{ title }}
          </div>
              ...
              >
                <el-form-item label="计划名称" prop="planName">
                  <el-input
                    ...
                    placeholder="计划名称"
                    :disabled="drawerType === 'editMaster'"
                  />
                </el-form-item>
                  ...
                  >
                    <el-radio-button
                      ...
                      :style="{
                        ...
                        borderColor: getPlanTypeNameColor(dict.label),
                        color: '#fff',
                      }"
                    />
                  </el-radio-group>
      ...
      <div v-if="projectInfo?.projectName" class="layout-process-right">
...
import { deepClone, getPlanTypeNameColor } from '@/utils/util';
...
const saveSubmitForm = () => {
  proxy.$refs['formRef'].validate(async valid => {
    if (valid) {
      const form = {
        ...formData.value,
        planOrderId: props.projectInfo.id,
      ...
      if (form.id) {
        ...
        form.planOrderId = props.projectId;
