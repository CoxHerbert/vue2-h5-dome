...
const getData = async () => {
  ...
  const res = await Api.wms.warehouse.getImrList({
    ...dataparam,
    warehouseId: dataparam.warehouseId
      ? dataparam.warehouseId?.id
        ? dataparam.warehouseId?.id
        : dataparam.warehouseId
      : undefined,
    locationId: dataparam.locationId
      ? dataparam.locationId?.id
        ? dataparam.locationId?.id
        : dataparam.locationId
      : undefined,
