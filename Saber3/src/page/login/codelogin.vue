<template>
  <el-form
    ...
    label-width="0"
  >
    <el-form-item v-if="tenantMode" style="display: none" prop="tenantId">
      <el-input
      ...
      <el-row :span="24">
        ...
        <el-col :span="8">
          <div class="login-code">
            <div
              @click="handleSend"
              class="login-code-phone"
              style="height: 42px; transform: translateY(-2px); line-height: 40px"
            >
              {{ msgText }}
            </div>
          </div>
    ...
    <div class="link-row">
      <el-button text @click="handleClickChangeMode" type="primary"
        >账户密码登录 <el-icon style="color: var(--el-color-primary)"><ArrowRight /></el-icon
      ></el-button>
    </div>
    <el-form-item>
      <el-button type="primary" @click.prevent="handleLogin" class="btn-submit"
        >{{ $t('login.submit') }}
      </el-button>
    </el-form-item>
  </el-form>
